...
export const Register: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Mapping "Full Name" to username for the backend mock
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center bg-slate-100 dark:bg-black transition-colors duration-300 overflow-hidden font-sans py-10">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div className="absolute top-[-10%] right-[-10%] w-[50%] h-[50%] bg-purple-500/30 rounded-full blur-[120px] mix-blend-multiply dark:mix-blend-normal dark:bg-purple-900/40 animate-blob"></div>
        <div className="absolute bottom-[-10%] left-[-10%] w-[50%] h-[50%] bg-blue-500/30 rounded-full blur-[120px] mix-blend-multiply dark:mix-blend-normal dark:bg-blue-900/40 animate-blob animation-delay-2000"></div>
      </div>
      ...
      <div className="relative z-10 w-full max-w-md p-4">
        <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border border-white/20 dark:border-slate-700/50 shadow-2xl rounded-3xl p-8 sm:p-10">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-slate-500 dark:text-slate-400 mt-2 text-sm text-center">Join the platform to analyze Sinhala comments</p>
          </div>
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div>
                ...
                <div className="relative">
                    <select
                        ...
                        className="w-full px-5 py-3 rounded-xl bg-slate-100 dark:bg-slate-800/50 border border-transparent dark:border-slate-700 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-slate-900 dark:focus:ring-white focus:bg-white dark:focus:bg-slate-800 transition-all appearance-none cursor-pointer"
                    >
            ...
            <Button type="submit" isLoading={loading} className="w-full mt-4 shadow-lg shadow-slate-900/20 dark:shadow-none">
                Register
            </Button>
